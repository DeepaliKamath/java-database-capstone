...
import com.example.clinicmanagementsystem.DTO.Login;
...
public class Servicess {
        ...
        public Servicess(TokenService tokenService, AdminRepository adminRepository, DoctorService doctorService,
