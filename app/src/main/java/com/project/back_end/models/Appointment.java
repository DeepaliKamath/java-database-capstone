...
@Transient
 private LocalDateTime  getEndTime(LocalDateTime appointmentDate){
...
private LocalDate getAppointmentDate(LocalDateTime appointmentDate) {
...
//    - A no-argument constructor is implicitly provided by JPA for entity creation.
  ...
  pubic Appointment(int studentId, Doctor doctor, Patient patient, LocalDateTime appointmentDate, int status){
    this.id = id;
    this.doctor = doctor;
